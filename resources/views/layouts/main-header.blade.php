                                ...
                                <div class="dropdown-menu">
                                    <div class="menu-header-content bg-primary text-right">
                                        <div class="d-flex">
                                            ...
                                            <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="\Markallread">تعين قراءة الكل</a></span>
                                        </div>
                                        <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 "><h6 id="notifications_count" style="color: yellow">{{ auth()->user()->unreadNotifications->count() }}</h6></p>
                                    </div>
                                    <div id="unreadnotifications">
                                    @foreach(auth()->user()->unreadNotifications as $notification)
                                        <div class="main-notification-list Notification-scroll">

                                            <a class="d-flex p-3 border-bottom" href="{{url('invoices_details')}}/{{$notification->data['id']}}" class="nav-link active">
        {{--                                        <a href="\ViewAll">--}}
